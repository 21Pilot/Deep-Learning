...
# CIFAR 10 data taken from : https://www.cs.toronto.edu/~kriz/cifar.html
# File name : cifar-10-python.tar.gz
...
model.model.fit_generator(Data_gen.flow(data.x_train, data.y_train, batch_size=Batch_size),                      	
...
print("Top-5 Accuracy:", final_result[2]) 
